...
describe("영상 모델 표", () => {
  // ⚠️ 2026-09-01 — **단계별의 기본이 2.0 으로 돌아왔다**(사장님 지시). 얼굴 든 참조를
  //   받는 모델이 그것뿐이라, 인물이 주인공인 영상이 2.5·H3 에서는 안 됐다.
  //   ★ 원클릭의 기본은 여전히 H3 다 — 표가 둘이라 갈릴 수 있다.
  it("고를 수 있는 것은 넷이고 단계별 기본은 2.0 이다", () => {
