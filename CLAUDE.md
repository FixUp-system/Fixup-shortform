...
> 결제**다. 저장 계층은 끝났다. 원가가 사용자 행동당 실제 현금(영상 한 편 $2.59)이라
...
>
> ⚠️ **차감 시점을 정해야 한다** — 지금 원장은 **호출이 끝난 뒤** 기록된다(사후). 크레딧은
> **부르기 전에** 막아야 하는데(`assertBudget` 이 그 자리다), 예약·확정 2단계로 갈지
> 사후 기록만으로 갈지가 설계 결정이다. 백그라운드에서 돈이 나가는 구조라 이 선택이 중요하다.
>
