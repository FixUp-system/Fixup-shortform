  ...
  return (
    ...
    <details className="prompt-edit">
      ...
      {/* ★ 2026-08-18 — 이 칸이 ①자료에서 **첫 화면**으로 옮겼다(만들 때 한 번 정한다).
          "자료 단계에서 고칠 수 있어요"는 그날부터 거짓이었다 — 없는 자리로 사장님을 보내는
          안내는 "고칠 수 있는 척하는 칸"과 같은 종류의 거짓말이다. */}
      <p className="preview-note">
        <strong>모든 영상에 함께 보내는 지시</strong>도 위 꼬리에 들어 있어요 — 그건 영상을
        만들 때 정하는 값이라 지금은 못 고쳐요. 이 컷만 바꾸려면 위 칸을 고쳐 주세요.
      </p>
