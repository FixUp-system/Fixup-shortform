...
// ★ label 은 **사장님이 읽는 말**이고, 지문에 실리는 것은 영어 clip 이다. 그래서 label 을
// 쉬운 말로 바꿔도 결과물은 한 글자도 안 바뀐다("실시간"→"보통", "극단적 슬로모션"→"슬로모션").
// 사장님은 영상 용어를 모른다(2026-08-13 사용자 지적).
export const SPEEDS = [
  ...
  { id: "realtime", label: "보통", note: "실제 속도", clip: "real-time speed, natural pacing" },
  { id: "fast", label: "빠르게", note: "폭발적으로", clip: "fast, explosive motion" },
  { id: "extreme_slowmo", label: "슬로모션", note: "절정에만", clip: "extreme slow motion, time nearly frozen" },
];
