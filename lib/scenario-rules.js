...
import { clipProfileForProject, sceneMinSecondsFor } from "./clip-limits.js";
...
export function checkScenario(scenario, project) {
  ...
  // ★ 장면 하한은 **모델 클립 하한이 아니다** — 통짜로 구울 프로젝트에서는 장면이
  //   클립이 아니라 스토리보드 칸이라 그 하한이 안 걸린다(sceneMinSecondsFor 머리말).
