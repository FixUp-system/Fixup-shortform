...
// ⚠️ 지우기(deleteProject)는 **그대로 소유자 전용**이다. 고치는 것과 없애는 것은 다른 일이고,
//   요청도 "수정"이었다. 열려면 그때 따로 연다.
...
export async function getProjectForViewing(id, viewerId) {
  ...
  //   사용자의 게시물을 단계별로 확인할 수 있게"). 한 값으로 둘을 겸하면 지우기까지
  //   함께 열린다 — deleteProject 는 설계상 소유자 전용이다(위 ownerScope 주석).
  //   · mine     — 내가 만들었는가. **지우기**가 본다.
