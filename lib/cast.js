...
반드시 JSON 하나만 출력: {"cast":[{"who":"이 인물이 누구인지 한 마디","look":"외형 — 머리·체형·옷차림","avatar_id":"준비된 인물 사진 중 가장 맞는 id(없으면 생략)","cuts":[이 인물이 보이는 컷 번호들]}],"props":[{"photo_id":"올린 사진의 id","cuts":[그 사진에 찍힌 것이 보이는 컷 번호들]}]}
규칙:
