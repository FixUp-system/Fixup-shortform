...
//
// ⚠️ **`.trim()` 만 한다 — 여기서 더 다듬지 마라.** 프롬프트와 각인이 같은 값을 읽어야
//    한다: 한쪽에만 정규화가 들어가면 프롬프트는 같은데 각인만 갈려 **거짓 낡음**이
//    유료 [다시 만들기]를 연다(그림 컷당 $0.08, Seedance 30초 한 편 ~$9).
//    바로 앞 태스크가 덮어쓰기 각인에서 마침표 하나로 그것을 겪었다.
