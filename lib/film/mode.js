...
export function imagePlanFor(mode, scenario, opts = {}) {
  ...
  if (focus === "person") {
    return [
      { key: "person", prompt: `A head-and-shoulders portrait of the main person of this video. ${PERSON_ONLY}. ${NO_TEXT}${CTX}` },
      { key: "person-full", prompt: `A full-body shot of the same person, standing, showing their outfit. ${PERSON_ONLY}. ${NO_TEXT}${CTX}` },
