...
export const VIDEO_PRICE = {
  ...
  //
  // ★ 값을 감으로 정하지 않았다. **이 표에 이미 있던 기준선**에서 뽑았다: 2.0 과 kling 의
  //   크레딧당 원가가 $0.050~0.057 로 모인다(우연이 아니라 그렇게 만든 표다).
  //   2.5 원가(lib/costs.js): 480p $0.2056/s · 720p $0.4622/s
  //     → 15초 $3.08 / $6.93 · 30초 $6.17 / $13.87
  //   그 기준선(≈$0.0555/크레딧)에 맞춰 **5의 배수로 올렸다** — 올림 방향이 우리에게
  //   안전하다는 위 480p 열의 판단과 같다. 결과: 480p $0.0560 · 720p $0.0554.
  ...
  "seedance-2.5": {
    "480p": { 15: 55, 30: 110, 45: 165, 60: 220 },
    "720p": { 15: 125, 30: 250, 45: 375, 60: 500 },
  },
