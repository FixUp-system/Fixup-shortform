...
export async function selectCandidate({ cut, scene, candidates, refImagePath, fetchImpl = fetch, apiKey = process.env.OPENAI_API_KEY }) {
...
검수 기준: 장면 설명과 일치 / 신체·손가락 오류 / 이미지 안 글자 깨짐${refImagePath ? " / 레퍼런스 피사체와 외형 일치" : ""}` },
