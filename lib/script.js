...
- **지어내도 되는 것과 안 되는 것을 가른다.** 사장님은 자료를 길게 주지 않는다 —
  ...
  ✗ **숫자·순위·실적·기간은 자료에 있는 것만** 쓴다. 확인할 수 있는데 확인하면 틀린 말은
    사장님이 책임진다. 판매 1위 · 후기 1,000건 · 재구매율 90% · 3만 명이 선택 ·
    30년 전통 — 자료에 없으면 한 자도 쓰지 않는다.
...
없는 사실을 지어내지도 않는다. 같은 말을 되풀이해 채우지도 않는다 — 셋 다 하느니 짧은 채로 둔다.`;
