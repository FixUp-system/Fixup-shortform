...
1. **총괄 한 문장** — 무엇을 만드는지 한 문장에. 길이(초)·화면 비율·형식·화풍·분위기를
   ...
   · 비율이 세로면(9:16) **세로 구도로** 짠다. 가로로 잡은 화면을 세로에 밀어 넣으면
     인물도 제품도 프레임 밖으로 잘린다.
...
4. **장면 진행과 대사** — 여기가 본문이고 가장 길다. 무슨 일이 어떤 순서로 일어나는지 쓴다.
   ...
   · **대사는 짧게.** 주어진 길이 안에 편하게 읽히는 만큼만 쓴다 — 넘치면 모델이 급하게
     읽거나 뒤를 잘라 먹는다. 말이 없어도 되는 장면은 비워 둔다.
...
6. **소리** — 앰비언스·음악, 그리고 **나레이션 목소리**.
   ...
   · **한 영상에 화자는 하나다.** 장면마다 다른 목소리를 지정하지 마라 — 사람이 바뀐다.
