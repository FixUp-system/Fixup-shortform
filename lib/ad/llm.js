...
export async function callJson({
  ...
  fake = fakeAdResponse,
  // ★ 요청 스키마도 **부르는 쪽이 정한다**(2026-08-21, 리뷰 정정). SCENARIO_SCHEMA 는
  //   additionalProperties:false + required 열 개짜리라 {"body":"..."} 같은 다른 모양은
  //   애초에 나올 수 없다 — Task 6 이 fake 만 바꾸고 이 자리를 놓쳐서, 가짜 모드는
  //   통과해도 진짜 API 호출은 항상 죽는 상태로 남았었다. 안 넘기면 예전 그대로
  //   SCENARIO_SCHEMA 다(광고 경로 회귀 0).
