...
export const AD_MODELS = [
  ...
  },
  {
    ...
    // ★ 2026-08-13 에 "원가가 크다"로 숨겼다가 **2026-08-19 에 다시 열었다**(사장님 요청).
    //   숨긴 동안에도 표·정가·엔드포인트·원가는 다 살려 두었기 때문에 이 한 줄을 지우는
    //   것으로 끝났다 — 값을 지웠으면 이미 2.5 로 만든 문서가 adVideoPrice 에서 던져
    //   화면째 죽었을 것이다(seedance-2.0-fast 가 정확히 그랬다).
