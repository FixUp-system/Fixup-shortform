...
export const AD_MODELS = [
  {
    ...
    // ★★★ **참조 사진 규약**(2026-08-21) — fal 스키마 원문 그대로다:
    //   "Refer to them in the prompt as **@Image1, @Image2**, etc. … Up to **9** images."
  ...
  },
  {
    ...
    // ⚠️ 스키마에 maxItems 가 **없다**. 열어 두는 대신 2.0 과 같은 9 로 잡는다 —
    //   모르는 상한은 **좁은 쪽**으로 본다(넘겨서 422 를 맞으면 값은 이미 나간 뒤다).
    refs: { field: "image_urls", max: 9, label: "@Image%n" },
