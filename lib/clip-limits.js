...
export const I2V_MODELS = [
  {
    ...
    // ★★ 이름이 **등급**이다(2026-08-31 사장님 지시 — 광고와 같은 이름을 쓴다).
    //   ⚠️ **'기본'이 가리키는 모델은 두 경로에서 다르다** — 광고의 기본은 MiniMax H3,
    //     여기 기본은 Seedance 2.0 이다. reel 표에는 H3 계열이 아직 배선돼 있지 않다
    //     (클립 프로필·정가표·컷 최소 초·통짜 상한이 없다). 배선하면 그때 같아진다.
    label: "기본",
