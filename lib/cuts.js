...
//   (lib/styles.js promptNoteOf)가 **같은 규칙**을 쓰기 때문이다. 두 군데 적으면 한쪽만
...
//
// ★ 판독은 promptNoteOf 한 자리다(lib/styles.js) — 각인(lib/steps.js)이 **같은 함수**를
//   부른다. 두 벌로 재면 프롬프트가 같은데 각인만 갈려 거짓 낡음이 유료 버튼을 연다.
