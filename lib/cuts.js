...
반드시 JSON 하나만 출력: {"environment":"이 영상의 무대 — 장소·시간대·조명 한 줄","shots":[{"shows":"화면에 보이는 것(정지 화면)","motion":"그 화면이 어떻게 움직이는지 한 줄","speed":"static|slow|realtime|fast|extreme_slowmo 중 하나"}]}
